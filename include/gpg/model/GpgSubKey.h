...
namespace GpgFrontend {
    ...
    public:
        ...
        [[nodiscard]] QString id() const { return _subkey_ref->keyid; }

        [[nodiscard]] QString fpr() const { return _subkey_ref->fpr; }

        [[nodiscard]] QString pubkey_algo() const { return gpgme_pubkey_algo_name(_subkey_ref->pubkey_algo); }
        ...
        [[nodiscard]] bool can_authenticate() const { return _subkey_ref->can_authenticate; }
        ...
        [[nodiscard]] QDateTime timestamp() const { return QDateTime::fromTime_t(_subkey_ref->timestamp); }

        [[nodiscard]] QDateTime expires() const { return QDateTime::fromTime_t(_subkey_ref->expires); }
