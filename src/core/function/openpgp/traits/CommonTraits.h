...
GF_DEF_OP_TRAITS(GetEngineVersionOpTag, "op_get_engine_version",
                 &GetEngineVersionGnuPGImpl,
                 {OpenPGPEngine::kGNUPG, &GetEngineVersionGnuPGImpl},
                 {OpenPGPEngine::kRPGP, &GetEngineVersionRpgpImpl});

GF_DEF_OP_TRAITS_RAW(BuildOpenPGPContextOpTag, "op_build_openpgp_context",
                     &BuildOpenPGPContextGnuPGImpl,
                     {OpenPGPEngine::kGNUPG, &BuildOpenPGPContextGnuPGImpl},
